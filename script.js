...
const audioTempoFim = new Audio('sons/beep.mp3')
...
function iniciarOuPausar() {
    ...
    iniciarOuPausarBt.textContent = "Pausar" //textContent deve ser usadad apenas para inserir texto, caso haja elementos HTML ultize innerHTML 
